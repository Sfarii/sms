 ...
 */
class StoreOrderLineDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('store_order_line_results', array('id'=> $options['id'])),
            'type' => 'GET',
            'pipeline' => 0
        ));
        ...
        $this->columnBuilder
            ->add(null, 'multiselect', array(
                'actions' => array(
                    array(
                        'route' => 'store_order_line_bulk_delete',
                        'icon' => '&#xE872;',
    ...
    {
        return 'SMS\StoreBundle\Entity\StoreOrderLine';
    }
    ...
    {
        return 'store_order_line_datatable';
    }
}
