...
/**
 * Class purchaseLineDatatable
 *
 * @package SMS\StoreBundle\Datatables
 */
class PurshaseLineDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('purchase_line_results', array('id'=> $options['id'])),
            'type' => 'GET',
            'pipeline' => 0
        ));
        ...
        $this->columnBuilder
            ->add(null, 'multiselect', array(
                'actions' => array(
                    array(
                        'route' => 'purchase_line_bulk_delete',
                        'icon' => '&#xE872;',
            ...
            ->add('state', 'boolean', array(
                ...
                'true_label' => $this->translator->trans('in_stock'),
                'false_label' => $this->translator->trans('store.state.padding'),
                'filter' => array('select', array(
                    'search_type' => 'eq',
                    'select_options' => array('' => $this->translator->trans('filter.field.all') , true => $this->translator->trans('in_stock') , false => $this->translator->trans('out_of_stock')) ,
    ...
    {
        return 'SMS\StoreBundle\Entity\PurchaseLine';
    }
    ...
    {
        return 'purchase_line_datatable';
    }
}
