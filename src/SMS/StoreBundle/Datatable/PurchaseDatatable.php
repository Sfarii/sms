...
class PurchaseDatatable extends AbstractDatatableView
{
    ...
    public function buildDatatable(array $options = array())
    {
        ...
        $this->columnBuilder
            ...
            ->add('purchaseDate', 'datetime', array(
                'title' => $this->translator->trans('purchase.field.purchaseDate'),
                'date_format' => "LL",
                'filter' => array('daterange', array('class' => "md-input")),
            ))
            ->add('reference', 'column', array(
                'title' => $this->translator->trans('purchase.field.reference'),
            ...
            ->add('state', 'boolean', array(
                ...
                'filter' => array('select', array(
                    'search_type' => 'eq',
                    'select_options' => array('' => $this->translator->trans('filter.field.all') , true => $this->translator->trans('in_stock') , false => $this->translator->trans('store.state.padding')) ,
                    'class' => "tablesorter-filter"
                ))
            ))
            ->add('provider.socialReason', 'column', array(
                'title' => $this->translator->trans('purchase.field.provider'),
                'filter' => array('select', array(
                    'search_type' => 'eq',
