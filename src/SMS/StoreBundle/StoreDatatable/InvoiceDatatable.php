...
class InvoiceDatatable extends AbstractDatatableView
{
    ...
    public function buildDatatable(array $options = array())
    {
        ...
        $this->columnBuilder
            ...
            ->add('reference', 'column', array(
                'title' => $this->translator->trans('invoice.field.reference'),
            ))
            ->add('delivery.quantity', 'column', array(
                'title' => $this->translator->trans('invoice.field.delivery.quantity'),
            ))
            ->add('delivery.deliveryDate', 'column', array(
                'title' => $this->translator->trans('invoice.field.delivery.deliveryDate'),
            ))
    ...
    {
        return 'SMS\StoreBundle\Entity\Invoice';
    }
