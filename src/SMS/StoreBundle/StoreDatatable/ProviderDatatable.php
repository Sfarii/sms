...
namespace SMS\StoreBundle\StoreDatatable;
 ...
 */
class ProviderDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('provider_results'),
            'type' => 'GET',
            'pipeline' => 0
        ));
        ...
        $this->columnBuilder
            ...
            ->add('socialReason', 'column', array(
                'title' => $this->translator->trans('provider.field.socialReason'),
            ))
            ->add('phone', 'column', array(
                'title' => $this->translator->trans('provider.field.phone'),
            ))
            ->add('address', 'column', array(
                'title' => $this->translator->trans('provider.field.address'),
            ))
            ->add('fax', 'column', array(
                'title' => $this->translator->trans('provider.field.fax'),
            ))
            ->add('email', 'column', array(
                'title' => $this->translator->trans('provider.field.email'),
            ))
