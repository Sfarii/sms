...
class ProductDatatable extends AbstractDatatableView
{
    ...
    public function buildDatatable(array $options = array())
    {
        ...
        $this->options->set(array(
            ...
            'search_delay' => 0,
            'state_duration' => 7200,
            'class' => "uk-table uk-table-align-vertical",
        ...
        $this->columnBuilder
            ...
            ->add('imageName', 'image', array(
                'title' => $this->translator->trans('product.field.image'),
                'relative_path' => 'images/store_image',
              )
            )
            ...
            ->add('status', 'column', array(
                'title' => $this->translator->trans('product.field.status'),
            ))
