 ...
 */
class DeliveryDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('delivery_results'),
            'type' => 'GET',
            'pipeline' => 0
        ));
        ...
        $this->columnBuilder
            ...
            ->add('quantity', 'column', array(
                'title' => $this->translator->trans('delivery.field.quantity'),
            ))
            ->add('deliveryDate', 'datetime', array(
                'title' => $this->translator->trans('delivery.field.deliveryDate'),
            ))
            ->add('product.productName', 'column', array(
                'title' => $this->translator->trans('delivery.field.product.productName'),
            ))
            ->add('provider.socialReason', 'column', array(
                'title' => $this->translator->trans('delivery.field.provider.socialReason'),
            ))
