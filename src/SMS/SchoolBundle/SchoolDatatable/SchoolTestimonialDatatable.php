...
/**
 * Class SchoolTestimonialDatatable
 *
 * @package SMS\SchoolBundle\Datatables
 */
class SchoolTestimonialDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('schooltestimonial_results'),
            'type' => 'GET',
            'pipeline' => 0
        ));
        ...
        $this->columnBuilder
            ->add(null, 'multiselect', array(
                'actions' => array(
                    array(
                        'route' => 'schooltestimonial_bulk_delete',
                        'icon' => '&#xE872;',
            ...
            ->add('title', 'column', array(
                'title' => $this->translator->trans('schooltestimonial.field.title'),
            ))
    ...
    {
        return 'SMS\SchoolBundle\Entity\SchoolTestimonial';
    }
    ...
    {
        return 'schooltestimonial_datatable';
    }
}
