...
/**
 * Class PricingFeatureDatatable
 *
 * @package SMS\SchoolBundle\Datatables
 */
class PricingFeatureDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('pricingfeature_results'),
            'type' => 'GET',
            'pipeline' => 0
        ));
        ...
        $this->columnBuilder
            ->add(null, 'multiselect', array(
                'actions' => array(
                    array(
                        'route' => 'pricingfeature_bulk_delete',
                        'icon' => '&#xE872;',
            ...
            ->add('pricing.pricingName', 'column', array(
                'title' => $this->translator->trans('pricingfeature.field.pricing'),
            ))
    ...
    {
        return 'SMS\SchoolBundle\Entity\PricingFeature';
    }
    ...
    {
        return 'pricingfeature_datatable';
    }
}
