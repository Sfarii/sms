...
/**
 * Class AboutUsDatatable
 *
 * @package SMS\SchoolBundle\Datatables
 */
class AboutUsDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
      ...
      $this->options->set(array(
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('aboutus_results'),
            'type' => 'GET',
            'pipeline' => 0
        ));
    ...
    {
        return 'SMS\SchoolBundle\Entity\AboutUs';
    }
