...
/**
 * Class FeatureDatatable
 *
 * @package SMS\SchoolBundle\Datatables
 */
class FeatureDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('feature_results'),
            'type' => 'GET',
            'pipeline' => 0
        ));
        ...
        $this->columnBuilder
            ...
            ->add('icon', 'column', array(
                'title' => $this->translator->trans('feature.field.icon'),
            ))
            ->add('title', 'column', array(
                'title' => $this->translator->trans('feature.field.title'),
            ))
            ->add('text', 'column', array(
                'title' => $this->translator->trans('feature.field.text'),
            ))
    ...
    {
        return 'SMS\SchoolBundle\Entity\Feature';
    }
