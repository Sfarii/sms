...
/**
 * Class RegistrationTypeDatatable
 *
 * @package SMS\PaymentBundle\Datatables
 */
class RegistrationTypeDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('registrationtype_results'),
            'type' => 'GET',
            'pipeline' => 0
        ));
        ...
        $this->columnBuilder
            ->add(null, 'multiselect', array(
                'actions' => array(
                    array(
                        'route' => 'registrationtype_bulk_delete',
                        'icon' => '&#xE872;',
            ...
            ->add('registrationTypeName', 'column', array(
    ...
    {
        return 'registrationtype_datatable';
    }
}
