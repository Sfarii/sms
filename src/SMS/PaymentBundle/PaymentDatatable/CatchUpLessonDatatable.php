...
/**
 * Class CatchUpLessonDatatable
 *
 * @package SMS\PaymentBundle\Datatables
 */
class CatchUpLessonDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('catchuplesson_results'),
            'type' => 'GET',
            'pipeline' => 0
        ));
        ...
        $this->columnBuilder
            ->add(null, 'multiselect', array(
                'actions' => array(
                    array(
                        'route' => 'catchuplesson_bulk_delete',
                        'icon' => '&#xE872;',
            ...
            ->add('typePaymentName', 'column', array(
                'title' => $this->translator->trans('catchuplesson.field.catchUpLessonName'),
            ))
            ->add('price', 'column', array(
                'title' => $this->translator->trans('catchuplesson.field.price'),
                "render" => $this->translator->trans('payment.unit.price')
            ))
            ->add('registrationFee', 'column', array(
                'title' => $this->translator->trans('catchuplesson.field.registrationFee'),
                "render" => $this->translator->trans('payment.unit.price')
            ))
            ...
            ->add(null, 'action', array(
                ...
                'actions' => array(
                    array(
                        'route' => 'catchuplesson_registration_new',
                        ...
                        'attributes' => array(
                            'rel' => 'tooltip',
                            'title' => $this->translator->trans('catchuplesson.registration.title'),
                        ),
                    ),
                    array(
                        'route' => 'catchuplesson_show',
                        'route_parameters' => array(
                            'id' => 'id'
                        ),
                        'icon' => '&#xE8F4;',
                    ...
                    array(
                        'route' => 'catchuplesson_statistics',
                        'route_parameters' => array(
                            'id' => 'id'
                        ),
                        'icon' => '&#xE8B8;',
    ...
    {
        return 'catchuplesson_datatable';
    }
}
