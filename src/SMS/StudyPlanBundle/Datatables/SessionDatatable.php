 ...
 */
class SessionDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('session_results'),
            'type' => 'GET',
            'pipeline' => 0
        ));
        ...
        $this->columnBuilder
            ...
            ->add('sessionName', 'column', array(
                'title' => $this->translator->trans('session.field.sessionName'),
            ))
            ->add('startTime', 'datetime', array(
                'title' => $this->translator->trans('session.field.startTime'),
                'date_format' => "HH:mm"

            ))
            ->add('endTime', 'datetime', array(
                'title' => $this->translator->trans('session.field.endTime'),
                'date_format' => "HH:mm"
            ))
