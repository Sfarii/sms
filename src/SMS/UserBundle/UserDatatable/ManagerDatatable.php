 ...
 */
class ManagerDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('manager_results'),
            'type' => 'GET',
            'pipeline' => 0
        ));
        ...
        $this->columnBuilder
            ...
            ->add('firstName', 'column', array(
                'title' => $this->translator->trans('manager.field.firstName'),
            ))
            ->add('lastName', 'column', array(
                'title' => $this->translator->trans('manager.field.lastName'),
            ))
            ->add('username', 'column', array(
                'title' => $this->translator->trans('manager.field.username'),
            ))
            ->add('email', 'column', array(
                'title' => $this->translator->trans('manager.field.email'),
            ))
    ...
    {
        return 'SMS\UserBundle\Entity\Manager';
    }
