...
namespace API\Datatables\AdministrativeDatatable;
 ...
 *
 * @package SMS\AdministrativeBundle\Datatables
 */
class AttendanceDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->columnBuilder
            ...
            ->add('status', new AttendanceColumn(), array(
                'title' => $this->translator->trans('attendance.field.status'),
                'editable' => true,
            ))
        ;
    }
