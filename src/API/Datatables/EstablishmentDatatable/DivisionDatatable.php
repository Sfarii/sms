...
namespace API\Datatables\EstablishmentDatatable;
 ...
 *
 * @package SMS\EstablishmentBundle\Datatables
 */
class DivisionDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('division_results'),
            'type' => 'GET',
            'pipeline' => 0
        ));
        ...
        $this->columnBuilder
            ...
            ->add('divisionName', 'column', array(
                'title' => $this->translator->trans('division.field.divisionName'),
            ))
            ->add('startDate', 'datetime', array(
                'title' => $this->translator->trans('division.field.startDate'),
            ))
            ->add('endDate', 'datetime', array(
                'title' => $this->translator->trans('division.field.endDate'),
            ))
